...
import 'package:active_ecommerce_flutter/data_model/delete_account.dart';
...
class ProfileRepository {
  ...
  Future<DeleteAccount> deleteAccount(String token) async {
    Uri url = Uri.parse("${AppConfig.BASE_URL}/auth/delete");
